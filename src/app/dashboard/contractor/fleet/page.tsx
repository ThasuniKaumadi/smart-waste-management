...
export default function ContractorFleetPage() {
    ...
    async function saveVehicle() {
        if (!vehicleForm.plate_number || !vehicleForm.type) {
            setErrorMsg('Plate number and type are required.')
            return
        }
        setSubmitting(true)
        setErrorMsg('')
        ...
        if (error) {
            setErrorMsg('Failed to save vehicle: ' + error.message)
        } else {
    ...
    async function saveMaintenance() {
        if (!maintenanceForm.vehicle_id || !maintenanceForm.date) {
            setErrorMsg('Vehicle and date are required.')
            return
        }
        setSubmitting(true)
        setErrorMsg('')
        ...
        if (error) {
            setErrorMsg('Failed to save maintenance record: ' + error.message)
        } else {
            ...
            setSuccessMsg('Maintenance record added.')
      ...
      `}</style>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-2 text-sm" style={{ color: '#717a6d', fontFamily: 'Inter, sans-serif' }}>
                            Manage your vehicles, maintenance and fuel records
                        </p>
                    </div>
            ...
            {loading ? (
                ...
                <>
                            ...
                            <div className="px-6 py-5 flex items-center justify-between"
                                ...
                                <div>
                                    ...
                                    <p className="text-xs mt-0.5" style={{ color: '#717a6d' }}>
                                        Service due or issues detected
                                    </p>
                                </div>
                                    ...
                                    return (
                                        <div key={v.id} className="attention-row">
                                            <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                                                ...
                                                <span className="material-symbols-outlined" style={{ color: vs.color, fontSize: '18px' }}>
                    ...
                    {/* Tabs */}
                    <div className="flex items-center gap-2 mb-6 s4">
                                            ...
                                            <div key={v.id} className="vehicle-card" onClick={() => setSelectedVehicle(v)}>
                                                <div className="flex items-start justify-between mb-4">
                                                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center"
                                                        style={{ background: vs.bg }}>
                                                        <span className="material-symbols-outlined" style={{ color: vs.color, fontSize: '24px' }}>
                                                            {vehicleTypeIcon(v.type)}
                                                        </span>
                                                    </div>
                                                    <span className="status-badge" style={{ background: vs.bg, color: vs.color }}>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    {serviceDays !== null && (
                                                        <div className="flex items-center gap-2">
                                                            <span className="material-symbols-outlined"
                                                                style={{ color: serviceDays <= 30 ? '#d97706' : '#94a3b8', fontSize: '14px' }}>build</span>
                                                    ...
                                                    {insuranceDays !== null && (
                                                        <div className="flex items-center gap-2">
                                                            <span className="material-symbols-outlined"
                                                                style={{ color: insuranceDays <= 30 ? '#ba1a1a' : '#94a3b8', fontSize: '14px' }}>shield</span>
                                                ...
                                                <div className="mt-4 pt-4 flex items-center justify-between"
                                                    ...
                                                    <span className="text-xs font-medium px-2 py-1 rounded-lg capitalize"
                                                        style={{ background: '#f8fafc', color: '#64748b' }}>{v.type}</span>
                                        ...
                                        <div key={m.id} className="table-row">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    <span className="status-badge" style={{ background: ms.bg, color: ms.color }}>
                                                        {m.status.replace('_', ' ')}
                                                    </span>
                                                </div>
                                                <p className="text-xs" style={{ color: '#717a6d' }}>
                                                ...
                                                {m.description && (
                                                    <p className="text-xs mt-1 truncate" style={{ color: '#94a3b8' }}>{m.description}</p>
                                                )}
                                            </div>
                                            <div className="text-right flex-shrink-0">
                                                {m.cost && (
                                                    <p className="text-sm font-bold" style={{ color: '#00450d' }}>
                                                        LKR {m.cost.toLocaleString()}
                                                    </p>
                                                )}
                                                {m.status === 'in_progress' && vehicle && (
                                                    <button
                                                        onClick={() => updateMaintenanceStatus(m.id, 'completed', vehicle.id)}
                                                ...
                                                {m.status === 'scheduled' && vehicle && (
                                                    <button
                                                        onClick={() => updateMaintenanceStatus(m.id, 'in_progress', vehicle.id)}
                                                        className="mt-1 text-xs font-bold px-2 py-1 rounded-lg"
                        ...
                        <div className="bento-card s5">
                            <div className="px-6 py-5 flex items-center justify-between"
                                ...
                                <div>
                                    ...
                                    <p className="text-xs mt-0.5" style={{ color: '#717a6d' }}>
                                        Total: LKR {stats.totalFuelCost.toLocaleString()}
                                    </p>
                                </div>
                            </div>
                            {fuelLogs.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-16 text-center">
                                    ...
                                    <p className="text-sm mt-1" style={{ color: '#94a3b8' }}>
                                        Fuel logs recorded by drivers will appear here
                                    </p>
                                </div>
                            ) : (
                                fuelLogs.map(f => (
                                    <div key={f.id} className="table-row">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-bold" style={{ color: '#181c22' }}>
                                                {f.vehicle_number || 'Unknown Vehicle'}
                                            </p>
                                            <p className="text-xs" style={{ color: '#717a6d' }}>
                                        ...
                                        <div className="text-right flex-shrink-0">
                                            <p className="text-sm font-bold" style={{ color: '#00450d' }}>
                                                LKR {f.fuel_cost.toLocaleString()}
                                            </p>
                        ...
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
                            ...
                            <div className="w-full max-w-2xl bento-card p-8" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input className="form-input" placeholder="e.g. Isuzu"
                                                value={vehicleForm.make}
                                                onChange={e => setVehicleForm(f => ({ ...f, make: e.target.value }))} />
                                        </div>
                                        <div>
                                            <label className="form-label">Model</label>
                                            <input className="form-input" placeholder="e.g. NQR"
                                                value={vehicleForm.model}
                                                onChange={e => setVehicleForm(f => ({ ...f, model: e.target.value }))} />
                                        </div>
                                        <div>
                                            <label className="form-label">Year</label>
                                            <input type="number" className="form-input" placeholder="e.g. 2020"
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" className="form-input" placeholder="e.g. 8"
                                                ...
                                                onChange={e => setVehicleForm(f => ({ ...f, capacity_tons: e.target.value }))} />
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <select className="form-input"
                                            ...
                                            onChange={e => setVehicleForm(f => ({ ...f, assigned_driver_id: e.target.value }))}>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input type="date" className="form-input"
                                                ...
                                                onChange={e => setVehicleForm(f => ({ ...f, last_service_date: e.target.value }))} />
                                        </div>
                                        <div>
                                            <label className="form-label">Next Service</label>
                                            <input type="date" className="form-input"
                                                value={vehicleForm.next_service_date}
                                                onChange={e => setVehicleForm(f => ({ ...f, next_service_date: e.target.value }))} />
                                        </div>
                                        <div>
                                            <label className="form-label">Insurance Expiry</label>
                                            <input type="date" className="form-input"
                                                value={vehicleForm.insurance_expiry}
                                                onChange={e => setVehicleForm(f => ({ ...f, insurance_expiry: e.target.value }))} />
                                        </div>
                                    </div>
                                ...
                                <div className="flex gap-3 mt-6">
                                    <button className="btn-secondary flex-1 justify-center"
                                        onClick={() => { setShowVehicleForm(false); setEditingVehicle(null); setErrorMsg('') }}>
                                        Cancel
                                    </button>
                                    <button className="btn-primary flex-1 justify-center"
                                        onClick={saveVehicle} disabled={submitting}>
                                        {submitting ? (
                    ...
                    {showMaintenanceForm && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
                            ...
                            <div className="w-full max-w-lg bento-card p-8" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <select className="form-input"
                                            ...
                                            onChange={e => setMaintenanceForm(f => ({ ...f, vehicle_id: e.target.value }))}>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select className="form-input"
                                                ...
                                                onChange={e => setMaintenanceForm(f => ({ ...f, maintenance_type: e.target.value }))}>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" className="form-input" placeholder="e.g. 12000"
                                                value={maintenanceForm.cost}
                                                onChange={e => setMaintenanceForm(f => ({ ...f, cost: e.target.value }))} />
                                        </div>
                                        <div>
                                            <label className="form-label">Service Provider</label>
                                            <input className="form-input" placeholder="e.g. Colombo Auto Services"
                                                value={maintenanceForm.service_provider}
                                                onChange={e => setMaintenanceForm(f => ({ ...f, service_provider: e.target.value }))} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" className="form-input"
                                                ...
                                                onChange={e => setMaintenanceForm(f => ({ ...f, next_due_date: e.target.value }))} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3 mt-6">
                                    <button className="btn-secondary flex-1 justify-center"
                                        onClick={() => { setShowMaintenanceForm(false); setErrorMsg('') }}>
                                        Cancel
                                    </button>
                                    <button className="btn-primary flex-1 justify-center"
                                        onClick={saveMaintenance} disabled={submitting}>
                                        {submitting ? (
                                            <div className="w-4 h-4 border-2 border-t-transparent rounded-full animate-spin"
                                                style={{ borderColor: 'white', borderTopColor: 'transparent' }} />
                                        ) : (
