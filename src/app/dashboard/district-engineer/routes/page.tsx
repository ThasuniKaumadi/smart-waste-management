...
export default function DERoutesPage() {
    ...
    async function loadData() {
      ...
      `)
        ...
        const uniqueWards = [...new Set((routesData || []).map((r: any) => r.ward).filter(Boolean))]
      ...
      `}</style>
            ...
            <section className="mb-10 s1">
                <span className="text-xs font-bold uppercase block mb-2"
                    ...
                    District Engineering · Route Monitoring
                </span>
                ...
                <p className="text-sm mt-1" style={{ color: '#717a6d' }}>
                    {profile?.district} · All contractor routes across all wards
                </p>
            </section>
            ...
            {wardCoverage.length > 0 && (
                <div className="mb-8 s3">
                    <h3 className="font-headline font-bold text-lg mb-4" style={{ color: '#181c22' }}>
                        Ward Coverage
                    </h3>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '12px' }}>
                        {wardCoverage.map(w => (
                            <div key={w.ward} className="ward-card"
                                ...
                                <p style={{ fontSize: '13px', fontWeight: 700, color: '#181c22', fontFamily: 'Manrope, sans-serif', marginBottom: '8px' }}>
                                    {w.ward}
                                </p>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center px-8">
                        ...
                        <p style={{ fontSize: '14px', color: '#94a3b8' }}>
                            No routes have been created for {profile?.district} yet
                        </p>
                    </div>
                ) : (
                    <div>
