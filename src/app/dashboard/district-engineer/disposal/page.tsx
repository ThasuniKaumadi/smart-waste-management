...
export default function DEDisposalPage() {
    ...
    async function loadData() {
        ...
        if (p?.district) {
            recordsQuery = recordsQuery.eq('district', p.district)
        }
                                ...
                                {filteredRecords.length === 0 ? (
                                    <div className="flex flex-col items-center justify-center py-16 text-center">
                                        ...
                                        <p className="text-sm mt-1" style={{ color: '#94a3b8' }}>
                                            Disposal records for your district will appear here
                                        </p>
                                    </div>
                                ) : (
                                                    ...
                                                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                                                        ...
                                                        {record.blockchain_tx && (
                                                            <span className="status-badge"
                                                                style={{ background: '#f5f3ff', color: '#7c3aed', fontSize: '10px', padding: '2px 8px' }}>
                                                                on-chain
                                                            </span>
                                                        )}
                                                    </div>
                        ...
                        <div className="bento-card s4">
                            {discrepancies.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-16 text-center">
                                    ...
                                    <p className="text-sm mt-1" style={{ color: '#94a3b8' }}>
                                        All disposal records match for your district
                                    </p>
                                </div>
                            ) : (
                                discrepancies.map((disc: any) => (
                                    <div key={disc.id} className="record-row">
                                        <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                                            ...
                                            <span className="material-symbols-outlined" style={{ color: '#ba1a1a', fontSize: '22px' }}>
                                                flag
                                            </span>
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className="status-badge"
                                                    style={{ background: '#fef2f2', color: '#ba1a1a', fontSize: '10px', padding: '2px 8px' }}>
