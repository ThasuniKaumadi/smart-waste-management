                    ...
                    <div className="profile-card a2">
                        ...
                        <div style={{ marginTop: 20, display: 'flex', gap: 10 }}>
                            ...
                            <button className="save-btn" onClick={() => setActiveTab('password')} style={{ background: '#1b5e20' }}>
                                <span className="ms" style={{ fontSize: 18 }}>lock_reset</span>Change Password
                            </button>
                        </div>
                    </div>
                )}
                    ...
                    <div className="profile-card a2">
                        ...
                        <div style={{ borderTop: '1px solid #f0f2ee', marginTop: 28, paddingTop: 24 }}>
                            ...
                            {[
                                ...
                                { icon: 'devices', text: 'After changing your password, other active sessions remain valid until they expire.' },
                            ].map((note, i) => (
