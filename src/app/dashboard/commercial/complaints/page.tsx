      ...
      `}</style>
            ...
            <section className="mb-10 s1">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        <span className="text-xs font-bold uppercase block mb-2" style={{ letterSpacing: '0.2em', color: '#717a6d', fontFamily: 'Manrope, sans-serif' }}>Commercial Portal</span>
                        ...
                        <p className="text-sm mt-1" style={{ color: '#717a6d' }}>{profile?.district || 'Your establishment district'}</p>
                    </div>
